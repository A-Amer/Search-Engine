...
//           Logger.getLogger(DBmanager.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void AddSeedRestricted(){
        Statement statement ;
        ResultSet SeedResult ;
        ResultSet SpamResult;
        ResultSet DegreeResult;
       try {
...
//           Logger.getLogger(DBmanager.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public  boolean InsertPagesInOut(String url , int pin , int pout)
    {
        ...
        try{
            ...
            cstmt.setString("URL" , url) ; 
            cstmt.setString("pin", new Integer(pin).toString()) ; 
            cstmt.setString("pout",new Integer(pout).toString());
            x = cstmt.execute();
